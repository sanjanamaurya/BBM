...
import 'package:tiranga/model/plinko_result.dart';
import 'package:tiranga/model/user_model.dart';
import 'package:tiranga/plinko/lesson_02/objects/ball_dynamic.dart';
import 'package:http/http.dart' as http;
import 'package:tiranga/plinko/utils/plinko_loss_popup.dart';
import 'package:tiranga/plinko/utils/plinko_win_popup.dart';
...
//           .get(Uri.parse(ApiUrl.plinkoBetHistory + "userid=$token&limit=1"))
...
//             print("win_amount");
//           }
//           List<PlinkoBetHistory> plinkolist = data
//               .map((jsonMap) => PlinkoBetHistory.fromJson(jsonMap))
//               .toList();
//           win_amount != '0'
