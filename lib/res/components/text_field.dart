          ...
          decoration: InputDecoration(
            ...
            border: OutlineInputBorder(
                borderSide: borderSide == null
                    ? const BorderSide(width: 0, color: AppColors.scaffolddark,)
                    : borderSide!,
            ...
            focusedBorder: OutlineInputBorder(
                borderSide: borderSide == null
                    ? BorderSide(width: 1, color: AppColors.scaffolddark.withOpacity(0.5))
                    : borderSide!,
                borderRadius: fieldRadius == null
                    ? const BorderRadius.all(Radius.circular(10))
                    : fieldRadius!),
            disabledBorder: OutlineInputBorder(
                borderSide: borderSide == null
                    ? const BorderSide(width: 1, color:AppColors.scaffolddark,)
                    : borderSide!,
                borderRadius: fieldRadius == null
                    ? const BorderRadius.all(Radius.circular(10))
                    : fieldRadius!),
