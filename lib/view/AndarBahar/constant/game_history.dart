...
import 'package:tiranga/model/bet_history_con.dart';
...
class GameHistoryPage extends StatefulWidget {
  final String gameId;
  const GameHistoryPage({Key? key,  required this.gameId}) : super(key: key);
...
class GameHistoryPageState extends State<GameHistoryPage> {
  ...
  Future<void> gameHistory() async {
    ...
    print("${ApiUrl.gameHistory}$gameIds&userid=$userId");
    setState(() {
